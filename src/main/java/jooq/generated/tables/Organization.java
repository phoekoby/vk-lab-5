...
public class Organization extends TableImpl<OrganizationRecord> {
     ...
     */
    public final TableField<OrganizationRecord, Long> INN = createField(DSL.name("inn"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.organization.checking_account</code>.
     */
    public final TableField<OrganizationRecord, Long> CHECKING_ACCOUNT = createField(DSL.name("checking_account"), SQLDataType.BIGINT.nullable(false), this, "");
