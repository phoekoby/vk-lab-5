...
public class InvoicePositionsDAOTest extends AbstractDataBaseTest{
    ...
    public void getAll() {
        ...
        assertTrue(invoices.containsAll(
                List.of(
                        ...
                        new InvoicePosition(7L, 100.0, 1000, 1L, 4L),
                        new InvoicePosition(8L, 125.0, 10000, 1L, 4L),
                        new InvoicePosition(9L, 100.0, 10000, 1L, 5L),
                        new InvoicePosition(10L, 100.0, 1000, 2L, 6L),
    ...
    public void saveInvoicePositions() {
        InvoicePosition notExistingInvoicePosition = new InvoicePosition(120.0, 1100, 1L, 1L);
    ...
    public void saveAllInvoicesPositions() {
        ...
        InvoicePosition notExistingInvoicePosition1 =new InvoicePosition( 120.0, 1100, 1L, 1L);
        InvoicePosition notExistingInvoicePosition2 = new InvoicePosition(120.0, 1100, 1L, 1L);
