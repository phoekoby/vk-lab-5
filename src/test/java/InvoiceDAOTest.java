...
public class InvoiceDAOTest extends AbstractDataBaseTest {
    ...
    public void saveInvoice() {
        Invoice notExistingInvoice = new Invoice(1L, Date.valueOf("2022-11-09"), 1L);
    ...
    public void saveAllInvoices() {
        ...
        Invoice notExistingInvoice1 = new Invoice(1L, Date.valueOf("2022-11-09"), 1L);
        Invoice notExistingInvoice2 = new Invoice(1L, Date.valueOf("2022-11-09"), 1L);
